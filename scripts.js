...
function getHungryInterval() {
    return Date.now() + Math.floor(Math.random() * 500 + 1000)
}

function getKingHungryInterval() {
    return Date.now() + Math.floor(Math.random() * 250 + 500)
}
...
function getNextStatus(mole) {
    switch (mole.status) {
        ...
        case 'gone':
            ...
            if (mole.king) {
                mole.next = getKingHungryInterval()
